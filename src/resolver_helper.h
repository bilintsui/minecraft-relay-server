/*
 * resolver_helper.h: Resolver helper process runtime
 *
...
/* Start a disposable fork-only helper, returning a nonblocking close-on-exec parent channel. The child retains no descriptor other than its private channel. */
