/*
 * route_generation_registry.h: Bounded live listener route generations
 *
...
/* Ownership of candidate transfers only on success. Publication is blocked while a pinned retired generation remains live. */
